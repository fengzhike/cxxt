shareJs = {
	init:function(){
		...
		$.get(mainJs.getApiUrl('/urming_quan/user/getWxJsApi'), {url:location.href.split('#')[0],random:Math.random()}, function(data){
			var r = $.parseJSON(data);alert(data);
			wx.config({
			...
			wx.ready(function(){
				wx.onMenuShareAppMessage({
					title: '创新学堂创业基金', // 分享标题
					desc: '我们在创新学堂发了创业基金给您，立刻来领吧', // 分享描述
					link: 'http://pkuietest.euming.com/edu/share.html', // 分享链接
					imgUrl: 'http://pkuietest.euming.com/edu/resource/images/present/top100.png', // 分享图标
